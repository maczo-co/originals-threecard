// originals-threecard — verifier CLI for the "Three Card Poker" Original.
//
...
// server-side Python (libs/game_math/threecard.py). Green = the JS matches the server bit-for-bit.
//
