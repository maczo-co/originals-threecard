# maczo Originals — Three Card Poker · Provably Fair

Welcome. This wiki explains how every **Three Card Poker** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Three Card Poker's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=threecard
- **Source / Node CLI:** https://github.com/maczo-co/originals-threecard
- **Published odds:** https://verify.maczo.co/originals/paytables/threecard.json
